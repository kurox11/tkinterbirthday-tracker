...
#every year that is exactly devisable by 4 is a leap year,
#except for years that are exactly devisable by 100
...
def days_till(month: int, day: int) -> int:
    ...
    returns number of days before the next DAY of the MONTH,
